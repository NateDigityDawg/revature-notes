...
public class AccountServiceTest {
	...
	public void testFindByOwnerId_returnAccountList() {
		...
		// create a new list of accounts to be in possesion of a new user that we create
		List<Account> bobsAccounts = new ArrayList<Account>();
		
		Account a = new Account(1, 500.00);
		Account b = new Account(2, 600.00);
		...
		// we have to go to the account service and write this method ourselves
